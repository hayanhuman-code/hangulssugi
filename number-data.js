...
//   1  세로 1획. 윗꼭지 갈고리도 밑줄도 없다 (10~19의 "1" 부분도 동일)
...
(function () {
  ...
  const GLYPH = {
    ...
    1: [{ d: 'M 100 35 L 100 175', start: [100, 35] }],
  ...
  function compose(digits) {
    ...
    // 원형 좌표는 셀 안에서 좌우 대칭이 아니다 — 2·3처럼 배가 오른쪽으로 부푼
    // 글자는 좌우 여백이 눈에 띄게 다르다. 두 자리 숫자는 이미 대칭으로
